...
author: "Abdullah Zeith Alfarizy (G1401231061)"
date: '`r Sys.Date()`'
output: 
  html_document:
...
-   Koefisien $Y_{t−1}$ (0.40694) juga signifikan. Ini adalah **estimasi untuk** $\lambda$. Nilai ini menunjukkan bahwa sekitar 40.7% dari efek di periode sebelumnya masih "terbawa" ke periode saat ini.
